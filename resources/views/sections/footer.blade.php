    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-16">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="{{ config('profile.cv_url') }}" target="_blank" class="inline-flex items-center text-[#8A9CBB] hover:text-[#3B82F6] dark:hover:text-[#5FA8FF] transition-colors group">
                    ...
                    <li>
                        <a href="{{ config('social.github') }}" target="_blank" class="inline-flex items-center text-[#8A9CBB] hover:text-[#3B82F6] dark:hover:text-[#5FA8FF] transition-colors group">
                    ...
                    <li>
                        <a href="{{ config('social.linkedin') }}" target="_blank" class="inline-flex items-center text-[#8A9CBB] hover:text-[#3B82F6] dark:hover:text-[#5FA8FF] transition-colors group">
                            <svg class="w-4 h-4 mr-2 group-hover:text-[#3B82F6] dark:group-hover:text-[#5FA8FF] transition-colors" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                            LinkedIn
                        </a>
                    </li>
                    <li>
                        <a href="https://mail.google.com/mail/?view=cm&fs=1&to={{ config('social.email') }}" target="_blank" class="inline-flex items-center text-[#8A9CBB] hover:text-[#3B82F6] dark:hover:text-[#5FA8FF] transition-colors group">
